            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-12">
                            <label for="title_description" class="form-label">Select Blog</label>
                            <select name="blog_id" class="form-control">
                                <option value="0">Select Blog</option>
                                @foreach($blogs as $blog)
                                    <option value="{{ $blog->id }}" {{ $data->blog_id == $blog->id ? 'selected' : '' }}>{{ $blog->title }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="title-description-container">
                                <div id="title_description_fields">
                                    ...
                                    @php
                                    $titledescriptions = $data->title_description ?? '';
                                    @endphp
                                ...
                                <button type="button" class="btn btn-primary add-more mt-2">Add More</button>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.add-more', function() {
        var html = `
        <div class="row g-3 title-description-row mt-4 mb-3">
