        ...
        <div class="border-0 mb-4">
            <div
                ...
                <div class="row align-items-center mb-3">
                    <div class="col-md-12">
                        <a href="{{ route('others.create') }}" class="btn btn-primary">Add Others</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card border-0 mb-1">
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        ...
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <h6 class="mb-3 fw-bold">{{ $other->title }} <span
                                    class="text-muted small fw-light d-block">Reference {{ $other->id }}</span>
                            </h6>
