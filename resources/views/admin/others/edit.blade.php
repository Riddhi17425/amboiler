    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Edit Process Data</h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('others.update', $data->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold">Process Data Information</h6>
                    </div>
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" id="input-file-front" name="image" class="dropify"
                                            data-default-file="{{ asset('public/others/' . $data->image) }}">
                                    </div>
                                    @if ($errors->has('image'))
