    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Edit Testimonials</h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('testimonials.update', $data->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold">Testimonials Information</h6>
                    </div>
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            <label class="form-label">Testimonials Name</label>
                            <input type="text" id="title" name="name" value="{{ $data->name }}" required
                                class="form-control">
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" id="input-file-front" name="image" class="dropify" 
                                            data-default-file="{{ asset('public/testimonials_images/' . $data->image) }}">
                                    </div>
                                    @if ($errors->has('image'))
                        ...
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold">Profile Image</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-front"> Image Upload</label>
                                        <input type="file" id="input-file-front" name="profile_image" class="dropify" 
                                            data-default-file="{{ asset('public/testimonials_profile_images/' . $data->profile_image) }}">
                                    </div>
                        ...
                        <!--    <input type="text" id="alt_tag" name="alt_tag" value="{{ $data->alt_tag }}" required-->
                        <!--        class="form-control">-->
                        <!--</div>-->
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#description').summernote({
            placeholder: 'Enter testimonials description here...',
            height: 300,
            toolbar: [
                ['style', ['style']],
