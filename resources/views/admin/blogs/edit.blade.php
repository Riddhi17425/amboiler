                    ...
                    <div class="card mb-3 p-3">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="status" name="status" class="form-control" required>
                                    @foreach ($statuses as $status)
                                        <option value="{{ $status }}"
                                            {{ old('status', $data->status ?? \App\Models\Blogs::STATUS_ACTIVE) === $status ? 'selected' : '' }}>
                                            {{ $status }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" id="front_image_alt" name="front_image_alt"
                                                value="{{ old('front_image_alt', $data->front_image_alt) }}"
                                                class="form-control">
                                        </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label" for="detail_image_alt">Detail Image Alt Text</label>
                                            <input type="text" id="detail_image_alt" name="detail_image_alt"
                                                value="{{ old('detail_image_alt', $data->detail_image_alt) }}"
                                                class="form-control">
                                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="detail_description" name="detail_description" class="form-control">{{ $data->detail_description }}</textarea>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-front">CTA Image</label>
                                        <input type="file" id="input-file-front" name="lower_banner" class="dropify"
                                            data-default-file="{{ asset('public/blogs/lower_banner/' . $data->lower_banner) }}">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label" for="lower_banner_alt">CTA Image Alt Text</label>
                                        <input type="text" id="lower_banner_alt" name="lower_banner_alt"
                                            value="{{ old('lower_banner_alt', $data->lower_banner_alt) }}"
                                            class="form-control">
                                    </div>
                                    @if ($errors->has('lower_banner'))
                                        <span class="text-danger">{{ $errors->first('lower_banner') }}</span>
                                    @endif
                                </div>
                            </div>
                            <!--<div class="col-md-12">-->
                            <!--    <label for="description" class="form-label">CTA Text</label>-->
                        ...
                        <!--        class="form-control">{{ $data->cta_image_text }}</textarea>-->
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="conclusion" name="conclusion" class="form-control">{{ $data->conclusion }}</textarea>
                            </div>
                            <div class="col-md-4">
