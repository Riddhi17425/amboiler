    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Certificates Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('certificates.store') }}">
            @csrf
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold">Certificates Information</h6>
                    </div>
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-12 mt-5">
                            <label class="form-label" for="image">Upload Pdf</label>
                            <input type="file" id="image" name="pdf" class="form-control" >
                        </div>
