                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="top_title" name="top_title" value="{{ $data->top_title }}" 
                                class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Title</label>
                            <input type="text" id="company_name" name="title" value="{{ $data->title }}" 
                                class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Milestone year</label>
                            <input type="text" id="year" name="year" value="{{ $data->year }}" required
                                class="form-control">
                        </div>
