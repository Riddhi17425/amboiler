    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Edit Hero Slide</h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('heroslide.update', $data->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold">Hero Slide Information</h6>
                    </div>
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-desktop"> Image Upload</label>
                                        <input type="file" id="input-file-desktop" name="image" class="dropify" 
                                            data-default-file="{{ asset('public/heroslide_images/' . $data->image) }}">
                                    </div>
                                    @if ($errors->has('image'))
                        ...
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold">Mobile Image</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-mobile">Mobile Image Upload</label>
                                        <input type="file" id="input-file-mobile" name="mobile_image" class="dropify" 
                                            data-default-file="{{ asset('public/heroslide_mobile_images/' . $data->mobile_image) }}">
                                    </div>
