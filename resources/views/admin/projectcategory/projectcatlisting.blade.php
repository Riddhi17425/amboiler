    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Project Category</h3>

                <div class="row align-items-center mb-3">
                    <div class="col-md-12">
                        <a href="{{ route('projectcategory.create') }}" class="btn btn-primary">Add Project Category</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-md-12 col-lg-12 ">
            <div class="card mb-3 bg-transparent p-2">
                @foreach ($data as $projectcategory)
                <div class="card border-0 mb-1">
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <h6 class="mb-3 fw-bold">{{ $projectcategory->category}}
                                <span class="text-muted small fw-light d-block">Reference {{ $projectcategory->id }}</span>
                            </h6>

                            <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2 d-inline-flex d-md-none">
                                <a href="{{ route('projectcategory.edit', ['projectcategory' => $projectcategory->id]) }}"
                                    class="btn btn-warning">Edit</a>
                                <form action="{{ route('projectcategory.destroy', ['projectcategory' => $projectcategory->id]) }}"
