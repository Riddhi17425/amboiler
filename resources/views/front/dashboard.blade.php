    ...
    <div class="container">
        <div class="row align-items-center gx-md-5">
            ...
            <div class="col-lg-5">
                <div class="service_new_rt">
                    <img id="serviceImage" class="img-fluid"
                         src="{{ asset('public/services/service_home_image/'.$services->first()->service_home_image) }}" loading="lazy"
                         alt="{{ $services->first()->product_name }}">
                    <div class="service_new_rt_child">
                        <a id="serviceTitle"
                        ...
                        <div class="expert_1">
                            ...
                            <div class="readmore-box">
                              <div class="readmore-text">
                                ...
                                boilers,
                                heat
                                exchangers, economizers, HRSGs, WHRBs, condensers, coolers, and plate heat exchangers
                                (PHEs).
                                Whether it's on-site emergency repairs or full-scale workshop overhauls, our expert
                                teams
                                are
                                equipped to deliver fast, reliable solutions. With 24/7 rapid response availability
                                across
                                the
                                WorldWide, we ensure minimal downtime and maximum operational efficiency for your marine
                                and
                                industrial assets.</p>
                              </div>
                        ...
                        <div class="expert_2">
                            ...
                            <div class="readmore-box">
                              <div class="readmore-text">
                                ...
                                precisely crafted to meet your application’s pressure, temperature, and dimensional
                                requirements. Every unit is designed with close attention to detail and manufactured
                                under
                                strict QA/QC protocols, ensuring long-term reliability, enhanced safety, and consistent
        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-12 col-lg-5 text-end  d-none d-lg-block">
                <a href="{{route('contact')}}" class="main_btn d-inline-block">Get in Touch
                    <span class="btn_svg">
                        <img src="{{ asset('public/front/images/blue_gear.svg')}}" loading="lazy" alt="setting icon"
                            class="img-fluid">
                    </span>
                </a>
            </div>
            ...
            <div class="col-sm-12 col-lg-4 d-none d-md-block">
                <div class="linkedin_slider_arrow">
                    <div class="d-flex gap-3 align-items-center justify-content-end">
                        ...
                        <img src="{{ asset('public/front/images/slider_rightarrow.svg')}}" loading="lazy" alt="right"
                            id="linkedin-next" class="linkedin-next" style="cursor: pointer;">
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 form_item">
                                    ...
                                    <div class="phone-input-wrapper">
                                        <input type="tel" class="phone" id="phone" name="phone" maxlength="15"
                                            minlength="10"
                                ...
                                <div class="col-lg-12">
                                    <div class="form_item">
                                        <div class="g-recaptcha" data-sitekey="6LfTLWAsAAAAADlJboKj1mvD4P2RsAQaSex8CYMp"
